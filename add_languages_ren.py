...
def add_language_command():
    ...
    ap.add_argument("--source-language", "-s", default=[], nargs='+', action="store", help="The commented-out language to add.")

    args = ap.parse_args()

    print("Adding sources to languages {}".format(args.languages))
    add_languages(args.languages, args.source_language or None)
